...
Require Import GroupCategory CategoryObjects ZeroGroup.
...
Section Exercise_4_5_3_8.
  ...
  Proof.
    refine (@Build_InitialObject
              _ Grp
              (existT _ _ ZeroGroup)
              (fun _ => HomomorphismFromZeroGroup _)
              (fun _ _ => HomomorphismFromZeroGroup_unique _)).
  Defined.

  Example Exercise_4_5_3_8_b : TerminalObject Grp.
  Proof.
    refine (@Build_TerminalObject
              _ Grp
              (existT _ _ ZeroGroup)
              (fun _ => HomomorphismToZeroGroup _)
              (fun _ _ => HomomorphismToZeroGroup_unique _)).
  Defined.
End Exercise_4_5_3_8.
