...
(** * Groupoids *)
(** Definition 4.2.3.7. A groupoid is a category [C] such that every
    morphism is an isomorphism.  If [C] and [D] are groupoids, a morphism
    of groupoids, denoted [F : C -> D], is simply a functor. The category
    of groupoids is denoted [Grpd]. *)
