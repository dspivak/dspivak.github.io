...
Require Import List.
Require Import MonoidAdjunction NaturalNumbersMonoid.
Require Import Hom ProductCategory Duals.
...
(** * Exercise 5.1.1.3 *)
Module Exercise_5_1_1_3.
  Local Open Scope list_scope.
  (** ** Problem *)
  (** Let [X = {a, b, c}] and let [M = ( ℕ, 1, * )] be the
      multiplicative monoid of natural numbers (see Example
      3.1.3.2). Let [f : X -> ℕ] be the function given by [f(a) = 7],
